...
public class OrganizationCreationDto {
    ...
    @Schema(name = "email",example = "", type = "String",description = "description : email of the organization")
    ...
    @Schema(name = "welcomeText",example = "", type = "String",description = "description : welcome text")
    private String welcomeText;

    @Schema(name = "aboutUsText",example = "", type = "String",description = "description : text about us")
